...
import com.any1.chat.interfaces.BasicClickListener
...
class ChatAdapter(val basicClickListener: BasicClickListener, val context: Context) : RecyclerView.Adapter<ChatAdapter.BaseViewHolder>() {
    ...
    private fun assignBackgroundForNormalMessage(emojiTextView: EmojiTextView,position: Int,relativeLayout: RelativeLayout){
        emojiTextView.textSize = 15f
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        ...
        return if(viewType == MESSAGE_RIGHT){
            holder = ChatRightHolder(LayoutInflater.from(parent.context).inflate(R.layout.chat_right, parent, false))
            holder
        }else{
            holder = ChatLeftHolder(LayoutInflater.from(parent.context).inflate(R.layout.chat_left, parent, false))
            holder
        }
    }
