...
import com.any1.chat.adapters.TagsAdapter
import com.any1.chat.models.Model
        ...
        searchview.setOnQueryTextListener(object : androidx.appcompat.widget.SearchView.OnQueryTextListener{
            ...
            override fun onQueryTextChange(newText: String): Boolean {
                if(newText.isNotEmpty()) {
                    ...
                    displaylist.clear()
                    displaylist.addAll(arr)
//                    Toast.makeText(this@searchtags, primarytag, Toast.LENGTH_SHORT).show()
//                    if(primarytag!=""){
//                        displaylist.add(0,primarytag)
//                    }
//                    if(secondarytag!=""){
//                        displaylist.add(1,secondarytag)
//                    }
//                    if(secondarytag!=""){
//                        displaylist.add(2,tertiarytag)
//                    }
                    val primarytag = sharedPreferences.getString("primarytag","").toString()
                    val secondarytag = sharedPreferences.getString("secondarytag","").toString()
                    val tertiarytag = sharedPreferences.getString("tertiarytag","").toString()
