...
import com.any1.chat.adapters.createGcAdapter
...
class CreateGroup : AppCompatActivity() {
    ...
    private lateinit var creategcadapter : createGcAdapter
...
//            Log.d("tags","primarytag:"+prefs.getString("primarytag","").toString())
//            Log.d("tags","secondarytag:"+prefs.getString("secondarytag","").toString())
//            Log.d("tags","tertiarytag:"+prefs.getString("tertiarytag","").toString())
//            Log.d("tags","primaryincg:"+prefs.getString("primaryincg","").toString())
//            Log.d("tags","secondaryincg:"+prefs.getString("secondaryincg","").toString())
//            Log.d("tags","tertiaryincg:"+prefs.getString("tertiaryincg","").toString())
...
//                            val fragment = home()
//                            val bundle = Bundle()
//                            bundle.putString("gctagstr",gctagstr)
...
//            Picasso.get().load((grouppreferences.getString("imgurl",""))).transform(CircleTransform()).into(groupphoto)
            ...
            Glide.with(this).load(grouppreferences.getString("imgurl","")).circleCrop().into(groupphoto)
            creategcadapter = createGcAdapter(tagarray,this)
