 ...
 * Use the [searchbyuniquetag.newInstance] factory method to
 * create an instance of this fragment.
 */
class searchbyuniquetag : Fragment() , OnSearchGroupClickListener{
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_searchbyuniquetag, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment searchbyuniquetag.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            searchbyuniquetag().apply {
