 ...
 * Use the [setname.newInstance] factory method to
 * create an instance of this fragment.
 */
class setname : Fragment() {
...
//        })
        ...
        themeswitch.setOnCheckedChangeListener(CompoundButton.OnCheckedChangeListener{compoundButton, ischecked->
            if(ischecked){
                (activity as AppCompatActivity?)!!.delegate.localNightMode = MODE_NIGHT_YES
                sharedPreferences2.edit().putString("theme","dark").apply()
            }else{
                (activity as AppCompatActivity?)!!.delegate.localNightMode = MODE_NIGHT_NO
