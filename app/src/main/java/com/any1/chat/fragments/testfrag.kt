...
import com.any1.chat.fragments.profile
 ...
 * Use the [testfrag.newInstance] factory method to
...
class testfrag : Fragment() {
    ...
    override fun onCreateView(
        ...
        bottomnav = view.findViewById<BottomNavigationView>(R.id.bottomnavigationview)
